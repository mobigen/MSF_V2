...
def usage() :
	print "usage : %s mdfs_ip mdfs_port mdfs_id mdfs_passwd recovery_file" % sys.argv[0]
	print "ex    : %s localhost 8000 mdfs mdfs mega/dc_test/20111129150000.cdb" % sys.argv[0]
	sys.exit()
...
MDFSDataLog.recovery_data(client, recover_file)
