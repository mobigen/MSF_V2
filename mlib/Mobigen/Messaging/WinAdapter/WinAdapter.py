...
# V3.1    | 070928 : jjinylee : SendMessageTimeout fail �� , retry Argument ó�� - 1�� retry
# V3.2	  | 071121 : jjinylee : Client -> BUS �� NTI/STI ������ strip('\n' ) �ϴ��� ���ϰ� ���� ( gui ���� ������ ��� by pass )
#---------------------------------------------------------------
	...
	while 1:
		...
		try :		
			...
			#{
				...
				# retry ���� ������� : list �� index ��  next �� �����Ͽ� ���� connector ����
				#-------------------------------------------------------
...
if __name__ == "__main__":
	...
	try :
		optStr = sfp.getOptStr()
		optList, args = getopt.getopt(sys.argv[1:], optStr+'t:r', ['level=', 'output-file='] )	# 07.09.28 : 'r' �߰�
