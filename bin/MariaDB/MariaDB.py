...
class MariaDB :
	def __init__(self, Parser, Database = None) :

		__LOG__.Trace(Database)
		self.mHost  = Parser.get('MARIADB', 'HOST')
		self.mUser  = Parser.get('MARIADB', 'USER')
		self.mPass  = Parser.get('MARIADB', 'PASS')
		if Database is None : self.mDatabase = Parser.get('MARIADB', 'DATABASE')
		else : self.mDatabase = Database
	...
	def connectMysql(self) :
		...
		#self.mysqlConn.autocommit(True)
